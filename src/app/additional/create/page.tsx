...
interface AdditionalAdd {
    name: string;
    value: number;
}

const AdditionalRegistrationForm: React.FC = () => {
    const [item, setItem] = useState<AdditionalAdd>({
        name: '',
        value: 0,
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('http://localhost:5063/api/Additional', {
                method: 'POST',
                headers: {
        ...
        <div className="flex">
            ...
            <main className="flex-1 p-6 bg-gray-100">
                <div className="w-full max-w-4xl p-8 bg-white rounded-lg shadow-lg">
                    <h2 className="text-2xl font-bold text-center text-gray-900 mb-6">Cadastrar Adicional</h2>
...
export default AdditionalRegistrationForm;
